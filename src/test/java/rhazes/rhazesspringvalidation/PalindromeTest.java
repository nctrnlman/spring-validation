...
import rhazes.rhazesspringvalidation.data.Foo;
...
public class PalindromeTest {
    ...
    void palindromeInvalid() {
        Set<ConstraintViolation<Foo>> constraintViolations = validator.validate(new Foo("Rhazes"));
    ...
    void palindromeInvalidMessage() {
        ...
        Assertions.assertEquals("Data bukan Polindrome",message);
    }
}
